...
const articleSchema = require('../schemas/converter.json').definitions.converter;
const categorySchema = require('../schemas/portfolio.json').definitions.portfolio;
const commentSchema = require('../schemas/purchases.json').definitions.purchases;
const usersSchema = require('../schemas/users.json').definitions.users;
...
/** Validate data against article schema test */
...
exports.validateUser = makeKoaValidator(usersSchema, 'users');
